...
<div class = "container-fluid">
    <div class = "row p-2">
        ...
        <div class="col-md-5">
            <form class="form-inline" action="searchpdf.jsp" method="post">
        ...
        <div class = "col-md-3">
            ...
            <%
                ...
                if(u1!=null){
                    if("Afra Ibnat Tethye".equals(u1.getName())){
            %>
            <a href="" class="btn btn-primary text-white"><i class="fa-solid fa-face-meh"></i>${userobj.name}</a>
            ...
            <a href="cart.jsp" class="text-warning"><i class="fa-solid fa-cart-shopping fa-2x text-warning"></i>Cart</a> &nbsp; &nbsp;
            <a href="" class="btn btn-primary text-white"><i class="fa-solid fa-face-meh"></i>${userobj.name}</a>
            <a data-toggle="modal" data-target="#exampleModalCenter" class="btn btn-danger text-white"><i class="fa-solid fa-arrow-right-from-bracket"></i>Log out</a>
            <%
                }
            ...
            <%--<a href="login.jsp" class="btn btn-primary"><i class="fa-solid fa-right-to-bracket"></i>Log in</a>--%>
            <%--<a href="regis.jsp" class="btn btn-secondary text-white"><i class="fa-solid fa-user-plus"></i>Sign up</a>--%>
            <%--</c:if>--%>
        ...
        <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
                <%
                    ...
                    if(u2!=null && "Afra Ibnat Tethye".equals(u2.getName())){
                %>

                <a class="nav-link" href="admin/home.jsp">Home <span class="sr-only">(current)</span></a>
                <%
                }else{
                %>
