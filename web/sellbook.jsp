...
<div class="container-fluid" style="background-color: lightsteelblue; padding-bottom: 150px" >
    <div class="row p-3">
        <div class="col-md-4 offset-md-4 p-3">
            <div class="card cd">
                <div class="card-body">
                    <h4 class="text-center text-primary p-2">Sell Old Books</h4>
                    ...
                    <form action="AddOldServlet" method="post" enctype="multipart/form-data">
                        ...
                        <button type="submit" class="btn btn-primary m-2 text-center">Sell</button>
                    </form>
